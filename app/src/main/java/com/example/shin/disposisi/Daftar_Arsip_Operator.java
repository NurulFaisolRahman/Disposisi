...
public class Daftar_Arsip_Operator {
    private String nomor_surat,url,surat_dari,tanggal_surat,diterima_tanggal,nomor_agenda,sifat,perihal,status,bidang,seksi;

    public Daftar_Arsip_Operator(String nomor_surat, String url, String surat_dari, String tanggal_surat, String diterima_tanggal, String nomor_agenda, String sifat, String perihal, String status, String bidang, String seksi) {
