...
public class RV_Adapter_Disposisi_Bidang extends RecyclerView.Adapter<RV_Adapter_Disposisi_Bidang.ViewHolderDisposisiBidang>{
    ...
    public ViewHolderDisposisiBidang onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(ContextDisposisiBidang).inflate(R.layout.daftar_disposisi_bidang,parent,false);
    ...
    public static class ViewHolderDisposisiBidang extends RecyclerView.ViewHolder {
        ...
        public ViewHolderDisposisiBidang(View ItemView){
            ...
            DisposisiBidang = ItemView.findViewById(R.id.DisposisiBidang);

            SuratDari = ItemView.findViewById(R.id.DisposisiBidangSuratDari);
            NomorSurat = ItemView.findViewById(R.id.DisposisiBidangNomorSurat);
            TanggalSurat = ItemView.findViewById(R.id.DisposisiBidangTanggalSurat);
            DiterimaTanggal= ItemView.findViewById(R.id.DisposisiBidangDiterimaTanggal);
            NomorAgenda = ItemView.findViewById(R.id.DisposisiBidangNomorAgenda);
            Sifat = ItemView.findViewById(R.id.DisposisiBidangSifat);
            Perihal = ItemView.findViewById(R.id.DisposisiBidangPerihal);
        }
    }
}
